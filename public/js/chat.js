...
const messageLocation= document.querySelector("#messageLocation").innerHTML
...
const autoscroll= ()=>{
  ...
  //Calculando la altura de los mensajes
  //Visible Height
...
$sendLocationButton.addEventListener("click",()=>{
  if (!navigator.geolocation){
    return alert("tu browser no soporta Geolocalizacion")
  }
